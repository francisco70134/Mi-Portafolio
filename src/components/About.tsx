...
export const About = () => {
  // Arreglo de colores para darle un toque distinto a cada número de las estadísticas
  const statColors = [
    'text-aurora-purple',
    'text-aurora-pink',
    'text-aurora-blue',
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            {/* Iteramos sobre los párrafos para no repetir código */}
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              {aboutInfo.stats.map((stat, index) => (
                <div key={index} className="bg-dark-card p-4 rounded-lg border border-dark-border hover:border-aurora-purple transition-colors duration-300">
                  <div className={`text-3xl font-bold ${statColors[index % statColors.length]}`}>
                    {stat.value}
                  </div>
          ...
          {/* Columna Derecha: Elemento Gráfico (Sustituye al emoji) */}
          <div className="relative flex justify-center">
            {/* Círculo con gradiente animado de fondo */}
